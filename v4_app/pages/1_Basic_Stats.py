"""FindMyLab v4 — Page 1: Basic Stats."""
...
st.caption("Use the button below the plot to download the interactive plot as HTML.")
...
st.caption(
    ...
    "Use the button below the plot to download the interactive plot as HTML."
)
